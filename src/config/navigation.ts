...
export const NAVIGATION = {
  PATIENT_SIDEBAR: [
    ...
    { title: "Consult Doctor", href: `${ROUTES.DASHBOARD}/consult-doctor`, icon: Stethoscope },
    ...
    { title: "My Appointments", href: `${ROUTES.DASHBOARD}/my-appointments`, icon: Calendar },
    { title: "Symptom Checker", href: `${ROUTES.DASHBOARD}/symptom-checker`, icon: ActivitySquare, isPlaceholder: true },
